  ...
  stages: [
    {
      ...
      cycles: 1,
      steps: [
        { label:"denature", duration:10, temp:42.0, data_collection:{ramp_end:false, hold_end:false, ramp_continuous:false, hold_continuous:false} },
        ...
        { label:"melt", duration:10, temp:37.0, data_collection:{ramp_end:false, hold_end:false, ramp_continuous:false, hold_continuous:false} }
      ]
    }
  ]
};
